# `LLVM_full_assert_jll.jl` (v15.0.7+14)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/ad2e5f6c8b0a81d24209f128bf3d4aa80c234835/L/LLVM/LLVM_full_assert@15/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/ad2e5f6c8b0a81d24209f128bf3d4aa80c234835/L/LLVM/LLVM_full_assert@15/bundled)
