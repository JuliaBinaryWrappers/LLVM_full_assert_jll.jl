# `LLVM_full_assert_jll.jl` (v13.0.1+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/ba9489d7aee6a85d367350a6250e9bc3a37a8a49/L/LLVM/LLVM_full_assert@13.0.1/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.")
...
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/ba9489d7aee6a85d367350a6250e9bc3a37a8a49/L/LLVM/LLVM_full_assert@13.0.1/bundled)
