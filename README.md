# `LLVM_full_assert_jll.jl` (v21.1.8+1)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/2fa223a98fbd696bde157eb29021f9ddbf56fb86/L/LLVM/LLVM_full_assert@21/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/2fa223a98fbd696bde157eb29021f9ddbf56fb86/L/LLVM/LLVM_full_assert@21/bundled)
