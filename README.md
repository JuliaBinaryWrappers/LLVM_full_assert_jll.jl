# `LLVM_full_assert_jll.jl` (v13.0.1+1)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/8cf835a6e7496486a9f023135415813332882e8f/L/LLVM/LLVM_full_assert@13.0.1/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/8cf835a6e7496486a9f023135415813332882e8f/L/LLVM/LLVM_full_assert@13.0.1/bundled)
