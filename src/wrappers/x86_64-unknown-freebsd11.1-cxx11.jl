# Autogenerated wrapper script for LLVM_full_assert_jll for x86_64-unknown-freebsd11.1-cxx11
export liblto, libllvm, clang, opt, libclang, llvm_config, llvm_mca, llc
...
"""
function __init__()
    global artifact_dir = abspath(artifact"LLVM_full_assert")
