...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LLVM_full_assert_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("6ec703ca-3f29-566b-9bb1-b5c9e844abaf"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LLVM_full_assert", artifacts_toml) for e in artifacts["LLVM_full_assert"]]
...
if best_platform === nothing
    @debug("Unable to load LLVM_full_assert; unsupported platform $(triplet(platform_key_abi()))")
else
